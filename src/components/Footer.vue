<template>
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800 shadow-lg">
    <div class="mx-auto max-w-screen-xl text-center shadow-lg">
        <a href="#" class="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
            <svg class="mr-2 h-8" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <img class="https://static.wixstatic.com/media/84b06e_717d310324e54451a0195d5658c70004~mv2.png/v1/fill/w_640,h_366,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/84b06e_717d310324e54451a0195d5658c70004~mv2.png"/>
                <defs>
        ...
        <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
            ...
            <li>
                <a href="/profile" class="mr-4 hover:underline md:mr-6">Profile</a>
            </li>
        </ul>
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">Zeyy's</a>. All Rights Reserved.</span>
    </div>
  </footer>
</template>