                ...
                <div class="flex-auto p-6">
                    ...
                    <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                        <a href="#"
                            ...
                            <span
                                class="flex-shrink-0 text-3xl font-black uppercase tracking-tight opacity-100">LOGIN</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Selamat Datang </h4>
                    <p class="mb-6 text-gray-500">Silahkan Log In terlebih dahulu.</p>

                    <form id="" class="mb-4" @submit.prevent="performLogin">
                        <div class="mb-4">
                            <label for="email" class="mb-2 inline-block text-xs font-medium uppercase text-gray-700">Masukan Email Anda</label>
                            <input type="text"
