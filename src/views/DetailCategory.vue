<template>
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16" id="scroll_product">
      <center><h1 class="text-xl font-bold text-gray-900 dark:text-white">All Product</h1></center>
      <br>
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div v-for="category in getCategoriesBySlug" :key="category.id"
          ...
          <div class="px-4 py-3 w-72">
            <router-link :to="{ name: 'SingleProduct', params: { id: category.id } }" class="group">
              <a href="">
